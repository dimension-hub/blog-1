...
class CollectPhoneSettings extends ConfigFormBase {
  ...
  protected function getEditableConfigNames(): array {
    ...
    // custom_configuration.collect_phone.settings.yml.
    return [
      'custom_configuration.collect_phone.settings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->config('custom_configuration.collect_phone.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->config('custom_configuration.collect_phone.settings')
